...
public class PieHelper {
    ...
    public static ArrayList<ActionConfig> getCandyPieConfigWithDescription(
            Context context, String values, String entries) {
        String config = Settings.System.getStringForUser(
                    context.getContentResolver(),
                    Settings.System.CANDY_PIE_CONFIG,
                    UserHandle.USER_CURRENT);
        if (config == null) {
            config = PieConstants.CANDY_PIE_CONFIG_DEFAULT;
        }
        return ConfigSplitHelper.getActionConfigValues(context, config, values, entries, true);
    }

    public static void setCandyPieConfig(Context context,
