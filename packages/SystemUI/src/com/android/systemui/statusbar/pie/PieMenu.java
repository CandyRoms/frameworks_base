...
import com.android.internal.util.candy.PieConstants;
...
public class PieMenu extends FrameLayout {
    ...
    private void getDimensions() {
        ...
        mEnableColor = (Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.CANDY_PIE_ENABLE_COLOR, 0) == 1);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.CANDY_PIE_BACKGROUND), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.CANDY_PIE_SELECT), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.CANDY_PIE_OUTLINES), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.CANDY_PIE_STATUS_CLOCK), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.CANDY_PIE_STATUS), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.CANDY_PIE_CHEVRON), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.CANDY_PIE_JUICE), false, this);
            getDimensions();
        }
