...
public class MultiTouchGesturesListener implements PointerEventListener {
    ...
    public MultiTouchGesturesListener(Context paramContext, int fingers, Directions direction, Callbacks callbacks) {
